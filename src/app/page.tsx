  ...
  const features = [
    {
      ...
      description:
        "Instantly search and analyze any stock with real-time data and comprehensive insights.",
    },
    {
      icon: BarChart3,
      title: "Interactive Charts",
      description:
        "Visualize price movements, volume, and technical indicators with dynamic charting tools.",
    },
    {
      icon: Newspaper,
      title: "Latest Market News",
      description:
        "Stay informed with curated news and analysis from trusted financial sources.",
    },
    {
      icon: Shield,
      title: "No Registration Required",
      description:
        "Start analyzing stocks immediately without creating accounts or providing personal information.",
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        "Enter a stock symbol or company name to get started with your analysis.",
    },
    {
      step: "02",
      title: "Analyze Data",
      description:
        "View comprehensive charts, financial metrics, and technical indicators.",
    },
    {
      step: "03",
      title: "Stay Informed",
      description:
        "Read latest news and market insights to make informed decisions.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful tools and real-time data to help you make informed
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of investors who trust StockScope for their market
              analysis
            </p>
